...
$sql = "SELECT * FROM dbo_lote WHERE Partido_nro = $idPartido AND Lote_quinta = '$quinta' AND Lote_matricula != '0' AND blnActivo = '1'  ORDER BY Lote_manzana ASC, Lote_parcela ASC";
$res = mysql_query($sql);
$cant = mysql_num_rows($res);

}else{

$sql = "SELECT * FROM dbo_lote WHERE Partido_nro = $idPartido AND Lote_quinta = '$quinta' AND blnActivo = '1'  ORDER BY Lote_manzana ASC, Lote_parcela ASC";
$res = mysql_query($sql);
$cant = mysql_num_rows($res);
...
?><table border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td height="9" colspan="2"><h2>Listado beneficios en <? echo $partido_nombre ?> (Quinta <?=$quinta; ?>) - <?=$cant ;?> resultados </h2></td>
  </tr>
  <tr>
