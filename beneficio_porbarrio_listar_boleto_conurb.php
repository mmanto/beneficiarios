...
dbo_usuarios
ON dbo_familia.insert_usuario = dbo_usuarios.idUsuario
) where Barrio_nro = '$idBarrio' AND blnActivo = '1' ORDER BY Familia_res_adj ASC";
...
<table width="900" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td colspan="4"><h1>Generar boletos de compra-venta</h1></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="4">Seleccione los beneficios para los cuales desea generar el correspondiente boleto de compra-venta y pulse el boton &quot;Generar boleto&quot; que se ubica en la parte inferior del listado.</td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="84" height="8">Ordenar por:</td>
    <td width="221"><form><select name="ListeUrl" onChange="ChangeUrl(this.form)">
      <option value="<?=basename($_SERVER['PHP_SELF']); ?>?idBarrio=<?=$idBarrio; ?>&criterio=1" <?php if ($criterio == '1') { ?> selected="selected" <?php } ?>>Nomenclatura catastral</option>
	  <option value="<?=basename($_SERVER['PHP_SELF']); ?>?idBarrio=<?=$idBarrio; ?>&criterio=2" <?php if ($criterio == '2') { ?> selected="selected" <?php } ?>>Resolución de Adjudicaci&oacute;n</option>
    </select>
    </form>    </td>
    <td width="139"><strong>(
      <?=$cant; ?> 
  ...
  <tr>
	...
	<table width="900" border="0" cellspacing="0" cellpadding="0">
	 ...
	 <form method="post" action="pre_conurbano.php">	  
	<table width="900" border="1" cellspacing="0" cellpadding="3">
      ...
      <td width="221" class="titulo_dato">Apellido, nombre y documento </td>
      <td width="193" align="center" class="titulo_dato">Estado</td>
      <td width="104" align="center" class="titulo_dato">Fecha boleto</td>
      <td width="103" align="center" class="titulo_dato">&nbsp;</td>
      <td width="141" align="center" class="titulo_dato">Alta por </td>
...
?><tr>
    <td colspan="7" align="right">Marcar/desmarcar todos </td>
  ...
  <tr>
    ...
    <input type="submit" name="button" id="button" value="Generar boleto" /></td>
  </tr>
</table>
	 </form>
	<?php } ?></td>
