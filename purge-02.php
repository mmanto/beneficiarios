...
$res = mysql_query("SELECT * FROM dbo_lote WHERE blnConv = '0' ORDER BY Lote_nro ASC LIMIT 500");
...
blnConv = '1' WHERE Lote_nro = '$loteNum'";
...
echo "</br></br>Registros actualizados correctamente.<br><a href=\"purge-03.php\">Actualizar siguientes</a>";