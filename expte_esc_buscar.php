...
?>
<form action="expte_esc_informe.php" method="POST">
...
<table width="600" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td valign="top"><strong>Ingrese n&uacute;mero de Expte.: </strong></td>
    <td height="30" valign="top"><input name="expte_esc_busqueda" type="text" id="expte_esc_busqueda" /></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
