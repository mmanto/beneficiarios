...
INNER JOIN
dbo_proyecto_zonas
ON dbo_ficha.ficha_zona = dbo_proyecto_zonas.Zona_nro
) WHERE Ficha_nro = $idFicha";
$res = mysql_query($sql);
$ficha = mysql_fetch_array($res);
$zona_nombre = $ficha["Zona_nombre"];
...
<table width="800" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td width="51%" style="font-size:16px"><strong>Proyecto: <?=$proyecto_nombre; ?> | Zona: <?=$zona_nombre; ?></strong></td>
        <td width="9%">:</td>
        <td width="15%"></td>
...
<table width="100%" border="1" cellspacing="0" cellpadding="4">
              ...
              <tr>
				...
				elseif ($persona["Persona_oficio"] == '11') {echo "Carpintero/Herrero"; }
				...
				else {echo "Sin oficio declarado"; }
				 ?></td>
                </tr>
              <tr>
                <td colspan="5" align="right"><table border="0" cellpadding="0" cellspacing="0">
			  <tr>
			    <td style="color:#5C768B">Modificar datos de esta persona</td>
			    <td><a href="persona_modif2_form.php?idPersona=<?=$persona["Persona_nro"]; ?>&idFicha=<?=$idFicha; ?>&origen=<?=basename($_SERVER['PHP_SELF']); ?>"><img src="imagen/ico_edit.gif" alt="Editar" border="0" title="Editar"/></a>
			    </tr></table></td>
                </tr>
            </table>
</td></tr>
...
<tr>
  <td align="right"><a href="persona_alta2_form.php?idFicha=<?=$idFicha; ?>&cant=<?=$ficha["ficha_miembros_cant"]; ?>">[+] Agregar otra persona para esta ficha</a></td>
</tr>
        <tr>
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
