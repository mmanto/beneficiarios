    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <? if ($idExpte!='0') { ?>
          <table width="100%" border="0" cellspacing="0" cellpadding="4">
            ...
            <tr>
              ...
              <td bgcolor="#FFFFBB"><?=$expte_ubicacion; ?>
                &nbsp;</td>
            </tr>
      ...
      <tr>
        <td colspan="2" rowspan="3" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="2">
          ...
          <tr>
            <td width="4%" height="30" bgcolor="#EFEFEF">&nbsp;</td>
            <td width="96%" valign="bottom" bgcolor="#EFEFEF"><strong>Observaciones:</strong></td>
            </tr>
          <tr>
            <td valign="top" bgcolor="#EFEFEF">&nbsp;</td>
            <td valign="top" bgcolor="#EFEFEF"><?=$familia["Familia_observaciones"]; ?>
              &nbsp;<br /></td>
            </tr>
          <tr>
...
?>
  ...
  <tr>
    <td valign="top" <? if($b1_baja =='1' ) { echo "bgcolor=\"#EAE1E4\""; } if($b1_adj_pendiente =='1' ) { echo "bgcolor=\"#D0DCFB\""; }?> ><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td colspan="3">&nbsp;</td>
          <td width="43%" rowspan="12" valign="top">
            <?
$sql4 = "SELECT * FROM dbo_tarjeta WHERE Persona_nro = $b1_numero AND blnActivo = '1'";
              ...
              <tr>
                <td height="22" colspan="2">          
                  <table width="100%" cellpadding="5" cellspacing="0">
                    ...
                    <tr>
                      <td width="63" height="22" align="right" valign="bottom" bgcolor="#C9E3B0"><strong>Tarjeta: </strong></td>
                      <td width="149" valign="bottom" bgcolor="#C9E3B0"><?=$tarjeta["Tarjeta_numero"]; ?></td>
                    </tr>
                    <? if($user["p732"]=='1') { ?>
                    <tr>
                      <td height="22" colspan="2" align="center" valign="top" bgcolor="#C9E3B0">&nbsp;
                      <a href="tarjeta-pagos-historial.php?idTarjeta=<? echo $tarjeta["Tarjeta_nro"]; ?>&idFamilia=<?=$familia["Familia_nro"]; ?>">[Ver historial de pagos]</a></td>        
                    </tr>	
                    <? } ?>
                </table></td>
              </tr>
              <tr>
                <td width="53%" height="20">Pagado a la fecha:</td>
                <td width="47%">$ <?=$tarjeta["Tarjeta_monto_pago"]; ?></td>
              </tr>
              <tr>
		  ...
		  $saldo = $english_format_number = number_format($familia_montoadj -$tarjeta["Tarjeta_monto_pago"], 2, '.', ''); }
		   echo $saldo; ?></td>
              ...
              <tr>
                ...
                <td>$ <?=$tarjeta["Tarjeta_cancelacion_monto"]; ?>&nbsp; </td>
              </tr>
              <tr>
                <td height="20">Fecha cancelaci&oacute;n: </td>
                <td><?=$tarjeta["Tarjeta_cancelacion_fecha"]; ?></td>
              </tr>
              <tr>
                ...
                <table>
                  <tr>
                    <td style="color:#51865C">Modificar datos de la tarjeta</td><td>
                    <a href="tarjeta-modif-form.php?idTarjeta=<?=$tarjeta["Tarjeta_nro"]; ?>&idFamilia=<?=$persona_familia; ?>"><img src="imagen/ico_edit.gif" alt="Editar" border="0" title="Editar"/></a></td>
                  </tr>
                </table><? } ?>
                </td>
              </tr>
...
//Si no hay tarjeta compruebo si es conurbano. Si es conurbano, muestro alerta de no tarjeta
	...
	<table width="100%" cellpadding="4" cellspacing="0">
		    ...
		    <td height="30" colspan="3" align="center" valign="bottom" bgcolor="#C9E3B0"><strong>El titular no tiene  tarjeta asociada</strong></td></tr>
		     <? if($user["p735"]=='1') { ?>
            <tr>
		      <td height="20" colspan="3" align="center" valign="top" bgcolor="#C9E3B0"><a href="tarjeta-asignar-form.php?idPersona=<? echo $b1_numero; ?>">[Asociar una tarjeta existente]</a></td>
		      </tr>
            <tr>
...
<?	}} ?></td>
        ...
        <tr>
          ...
          <td width="35%"><strong><?=$b1_doc_tipo; ?> <?=$b1_doc_nro; ?></strong>&nbsp;</td>
          <td width="3%">&nbsp;</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td><strong><?=$b1_padre_nombre." ".$b1_padre_apellido; ?></strong>&nbsp;</td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td height="28">Datos de la madre:</td>
          <td><strong><?=$b1_madre_nombre." ".$b1_madre_apellido; ?></strong></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
        ...
        <tr>
          <td>&nbsp;</td>
          <td align="right" valign="top"><? if ($user["p713"] == '1') { ?>
			<table><tr><td>
			<a href="persona_modif_form.php?idPersona=<?=$b1_numero; ?>&origen=<?=basename($_SERVER['PHP_SELF']); ?>"><img src="imagen/ico_edit.gif" alt="Editar" border="0" title="Editar"/></a></td>
			  <td style="color:#5C768B">Modificar datos de esta persona</td></tr></table><? } ?>&nbsp;</td>
        </tr>
      </table></td>
  </tr>
<? $cant_tit++; } ?>
