...
<tr>
  ...
  <tr>
	...
	<table width="900" border="1" cellpadding="0" cellspacing="0" bordercolor="#999999">
      <tr>
...
?>
      <tr>
        ...
        <td align="center" valign="middle" ><img src="imagen/estado-<?=$expte_gescrit_estado; ?>.jpg" />&nbsp;</td>
        ...
        <td width="29" align="center" class="datos-center"><a href="
		<? if($user["p753"] == '1') { ?>
