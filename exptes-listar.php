...
$sql3 = mysql_query("SELECT * FROM dbo_exptes WHERE blnActivo = '1' ORDER BY $orden",$link);
...
<table width="900" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td height="9" colspan="2"><h1>Expedientes en el sistema (cant: <?=$cant; ?>) </h1></td>
  </tr>
  <tr>
    ...
    <td width="122"><? echo $user["HabExp"]; ?>&nbsp;</td>
  </tr>
  <tr>
    <td height="36" colspan="2" valign="middle"><a href="exptes-listar-area.php">[Volver al listado de expedientes]</a></td>
  </tr>
  <tr>
...
?>
      <tr <? if ($num_fila%2==0) { echo "bgcolor=\"#F0EEA4\""; }else{ echo "bgcolor=\"#F7F4CA\"";} ?>>
        <td align="center" ><?=$expte_caract; ?></td>
         ...
         <td width="33" align="center"><? if (($expte["Expte_ubicacion_area"] == $usuario_area && $user["HabExp"] <= '7') || ($user["HabExp"] <= '3')) { ?> <input type="checkbox" name="seleccion[]" value="<?=$expte["Expte_nro"]; ?>" /><? }else{ ?> - <? } ?></td>
        </tr>
	  ...
	  <tr>
		...
		<? } ?>
			...
			<input type="hidden" name="origen" value="<?=$expte_area; ?>" />			</td>
          </tr>
          <tr>
