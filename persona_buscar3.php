...
if (!$_POST["docfind"] && !$_POST["apellfind"]) {echo "<h2>Por favor, ingrese un criterio de busqueda</h2><p><a href=\"javascript:history.go(-1)\">Realizar una nueva b&uacute;squeda</a></p><p>&nbsp;</p>";
...
$apell_busqueda = $_POST["apellfind"];
...
$SQL1 = mysql_query("SELECT DISTINCT (Ficha_nro) FROM dbo_persona
WHERE Persona_apellido = $apell_busqueda AND Ficha_nro != '0' AND blnActivo = 1",$link);
...
<table width="750" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="8" colspan="2"><?=$criterio; ?> - <?=$apell_busqueda; ?> // <?=$cant; ?> - <?=$cant2;?> &nbsp;</td>
  </tr>
  <tr>
    <td height="8" colspan="2">&nbsp;</td>
  </tr>
...
$res = mysql_query("SELECT Persona_apellido, Persona_nombre FROM dbo_persona WHERE Ficha_nro = $ficha_nro AND Persona_apellido = $apell_busqueda AND blnActivo = '1' LIMIT 0,1");
$persona = mysql_fetch_array($res);	
}
...
$res = mysql_query("SELECT Persona_apellido, Persona_nombre FROM dbo_persona WHERE Familia_nro = $familia_nro AND Persona_apellido = $apell_busqueda AND blnActivo = '1' LIMIT 0,1");
$persona = mysql_fetch_array($res);	
}
	 ?>	  
	  <tr bgcolor="#FCE7C9">
