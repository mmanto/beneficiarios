...
<table width="600" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
	  <td height="30"><h2>3.a - Filtrar lotes.</h2></td>
  </tr>
</table>

<form action="cambiarBenecifioSelLoteB.php" method="post" enctype="multipart/form-data" name="f" id="f">
