...
) where Barrio_nro = '$idBarrio' AND Familia_matricula != '0' AND blnActivo = '1' AND Insert_tipo = '1' ORDER BY Lote_manzana, Lote_parcela ASC";
...
dbo_usuarios
ON dbo_familia.insert_usuario = dbo_usuarios.idUsuario
) where Barrio_nro = '$idBarrio' AND Expte_esc_nro != '0' AND blnActivo = '1' AND Insert_tipo = '1' ORDER BY Lote_manzana, Lote_parcela ASC";
...
dbo_usuarios
ON dbo_familia.insert_usuario = dbo_usuarios.idUsuario
) where Barrio_nro = '$idBarrio' AND Familia_cond_escrit = '1' AND Expte_esc_nro = '0' AND blnActivo = '1' AND Insert_tipo = '1' ORDER BY Lote_manzana, Lote_parcela ASC";
...
dbo_usuarios
ON dbo_familia.insert_usuario = dbo_usuarios.idUsuario
) where Barrio_nro = '$idBarrio' AND blnActivo = '1' AND Insert_tipo = '1' ORDER BY Lote_manzana, Lote_parcela ASC";
}
