...
if (!$_POST["refcarto"]) {echo "<h2>Por favor, ingrese un n&uacute;mero v&aacute;lido de referencia cartográfica</h2><p><a href=\"javascript:history.go(-1)\">Realizar una nueva b&uacute;squeda</a></p><p>&nbsp;</p>";
...
$refcarto = $_POST["refcarto"];


$sql = "SELECT * FROM dbo_ficha WHERE ficha_refcarto = '$refcarto' AND Ficha_nro != '0' AND blnActivo = '1'";
$res = mysql_query($sql);
	 ...
	 ?>	  
	  <tr bgcolor="#FCE7C9">
        ...
        <td align="center" bgcolor="#BCD8E0">
          <a href="javascript:ventana_modif('ficha_informe.php?idFicha=<?=$ficha["ficha_nro"]; ?>')">
          Ver informe</a></td>
        </tr>
<? } ?>
    </table>	
