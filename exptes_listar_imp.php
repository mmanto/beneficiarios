...
<table border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="24" colspan="2" valign="bottom"><a href="exptes_listar.php">Volver a versi&oacute;n com&uacute;n </a></td>
  </tr>
  <tr>
  ...
  <tr>
    <td height="4" colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="3">
      ...
      <tr>
        <td width="13%">Ordenar por: </td>
        <td width="28%"><form><select name="ListeUrl" onChange="ChangeUrl(this.form)">
	  ...
	  <option value="<?=basename($_SERVER['PHP_SELF']); ?>?ordenar=destino" <? if ($ordenar == 'destino') { ?> selected="selected" <? } ?>>Destino</option>
        ...
        <td width="59%"><a href="exptes_listar_imp.php"></a></td>
      </tr>
    </table></td>
        </tr>
    </table></td>
