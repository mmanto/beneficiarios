...
}elseif($ordenar == "barrio") {

$orden = "Barrio_nombre ASC";
...
) WHERE Expte_origen = '1' ORDER BY $orden",$link);
...
dbo_partido
ON dbo_expte_esc.idPartido = dbo_partido.Partido_nro
) WHERE Expte_origen = '2' ORDER BY $orden",$link);
...
<table border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="4" colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="3">
	  ...
	  <option value="<?=basename($_SERVER['PHP_SELF']); ?>?ordenar=barrio" <? if ($ordenar == 'barrio') { ?> selected="selected" <? } ?>>Barrio</option>
...
?>
      <tr>
        ...
        <td width="24" align="center" class="datos-center"><a href="expte_esc_modif_form.php?id=<? echo $expte_nro;?> "><img src="imagen/edit.png" alt="Editar expte." title="Editar expte." width="16" height="16" border="0" /></a></td>
