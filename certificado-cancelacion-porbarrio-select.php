...
<table border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<? if ($cant > 0) { ?>
	<form method="post" action="certificado-cancelacion-porbarrio.php">	  
...
?><tr>
  ...
  <tr>
    <td height="60" colspan="2" align="right" valign="bottom"><input type="hidden" name="idBarrio" value="<?=$idBarrio; ?>" /><input type="submit" name="button" id="button" value="Generar certificado" /></td>
  </tr>
  <tr>
    <td width="21">&nbsp;</td>
