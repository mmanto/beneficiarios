...
<table width="650" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td>
    <? if ($familia["Familia_beneficio_origen"] == '3'){ ?>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
	    <td colspan="4" bgcolor="#FFD6C1" height="36" align="center" style="font-size:18px; font-weight:bold">Beneficio Ley 24.374 </td>
	  </tr>
      <tr>
      ...
      <tr>
        <td height="36" colspan="4" align="center" bgcolor="#E6E6E6" style="font-size:16px;" >Circ. <strong><? echo $lote_circ; ?></strong> - Secc. <strong><? echo $lote_secc; ?></strong> - Ch. <strong><? echo $lote_ch; ?></strong> - Qta. <strong><? echo $lote_qta; ?></strong> - Fracc. <strong><? echo $lote_fr; ?></strong> - Mz. <strong><? echo $lote_mz; ?></strong> - Pc. <strong><? echo $lote_pc; ?></strong> - Subpc. <strong><? echo $lote_subpc; ?></strong></td>
      </tr>
      <tr>
        <td colspan="4">&nbsp;</td>
      </tr>
      <tr>
        <td height="26">Partida:</td>
        <td><?=$familia["Lote_partida"]; ?>&nbsp;</td>
        <td>&nbsp;</td>
        <td width="45%" rowspan="12" align="right" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="3">
          <tr>
            <td width="5%" bgcolor="#D2E1FF">&nbsp;</td>
            <td width="95%" bgcolor="#D2E1FF">Expediente de regularizaci&oacute;n</td>
          </tr>
          <tr>
            <td bgcolor="#D2E1FF">&nbsp;</td>
            <td bgcolor="#D2E1FF"><? echo $familia["Expte_ley_reg_num"]; ?>&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          ...
          <tr>
            ...
            <td bgcolor="#FFFF99">Expediente de consolidaci&oacute;n</td>
          </tr>
          <tr>
            <td bgcolor="#FFFF99">&nbsp;</td>
            <td bgcolor="#FFFF99"><? echo $familia["Expte_ley_cons_num"]; ?>&nbsp;</td>
          </tr>
        </table><? if ($user["p703"] == '1') { ?>
			<table border="0" cellpadding="0" cellspacing="0">
			  <tr>
			    <td height="200" style="color:#5C768B">&nbsp;</td>
			    <td>&nbsp;</td>
			    </tr>
			  <tr>
			    <td style="color:#5C768B">Modificar datos del beneficio</td><td>
			    <a href="beneficio_ley24374_modif_form.php?idFamilia=<?=$_GET["idFamilia"]; ?>&origen=<?=basename($_SERVER['PHP_SELF']); ?>"><img src="imagen/ico_edit.gif" alt="Editar" border="0" title="Editar"/></a></td>
                </tr></table><? } ?></td>
      </tr>
      <tr>
        <td width="20%" height="26">Registro Nro.:</td>
        <td width="31%"><strong>
          <? echo $familia["Expte_ley_registro"]; ?>
        </strong></td>
        <td width="4%">&nbsp;</td>
      </tr>
      <tr>
        <td height="26">Escribano:</td>
        <td height="26"><? echo $familia["Expte_ley_escribano_nombre"]; ?></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td height="26">Instancia alta:</td>
        <td height="26"><?
        if($familia["Expte_ley_alta_instancia"] == '1') { echo "Regularizaci&oacute;n"; }else{ echo "Consolidaci&oacute;n"; } ?>
		&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td height="26">N&uacute;mero escritura:</td>
        <td height="26"><? echo $familia["Familia_escritura"]; ?>&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td height="26">Fecha escritura:</td>
        <td><?
      ...
      <tr>
        ...
        <td><strong><? echo $usrModif["Nombre"]; ?></strong> (
          <?=$modifbenef; ?>
          )&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td colspan="2" rowspan="3" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="2">
          ...
          <tr>
            ...
            <td width="96%" valign="bottom" bgcolor="#E1E1E1"><strong>Observaciones:</strong></td>
          </tr>
          <tr>
