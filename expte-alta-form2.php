...
<!-- Copyright 2000,2001 Macromedia, Inc. All rights reserved. --><form action="expte-alta2.php" method="post">
<table width="900" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="75" align="left"><strong>Numero</strong></td>
    ...
    <td colspan="8"><select name ="origen" style="font-size:13px;">
		...
		$sql5 = "SELECT * FROM dbo_area ORDER BY Area_codigo";
		 ...
		 while ($iniciante = mysql_fetch_array($res5)) { ?>
              <option value="<?=$iniciante["Area_nro"]; ?>"><?=$iniciante["Area_codigo"]; ?> - <?=$iniciante["Area_nombre"]; ?></option>
		<? } ?>
            </select></td>
    <td colspan="3" rowspan="4" valign="top"><table width="97%" border="0" cellspacing="0" cellpadding="3">
      ...
      <tr>
        ...
        <td colspan="2" valign="bottom" bgcolor="#E7EBD8"><input name="blnEsc" type="checkbox" id="blnEsc" value="1" /></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td bgcolor="#E7EBD8">&nbsp;</td>
      ...
      <tr>
        <td height="26">&nbsp;</td>
        <td bgcolor="#E7EBD8">&nbsp;</td>
        <td colspan="2" valign="middle" bgcolor="#E7EBD8"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="19%">Partido:</td>
            <td width="81%"><select name="idPartido" id="idPartido">
  ...
  <tr>
    <td>&nbsp;</td>
    <td colspan="5"><textarea name="extracto" cols="36" rows="5" id="extracto" style="font-size:14px;"></textarea></td>
    <td colspan="3"><textarea name="observaciones" cols="25" rows="5" id="observaciones" style="font-size:14px;"></textarea></td>
    </tr>
  <tr>
    <td height="28">&nbsp;</td>
    <td>&nbsp;</td>
