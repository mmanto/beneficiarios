...
<table border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="24" colspan="2" valign="bottom"><a href="sbt-menu.php">Volver al menu</a> | <a href="exptes-dpes-listar-partido-imp.php?idPartido=<?=$idPartido; ?>">[Version para imprimir] </a></td>
  </tr>
  <tr>
...
?>
      <tr>
        <td height="30" align="center" ><?=$expte_caract; ?>-<?=$expte_num; ?>/<?=$expte_anio_res ?> <? if($expte_alcance != '0') {echo "Alc. ".$expte_alcance;}?> <? if($expte["Expte_extracto"] == "COMPLETAR EXTRACTO") { echo "<img src='imagen/alerta.png'>"; } ?> </td>
		<td align="center"><?=$partido_nombre; ?></td>
		<td align="center"><?=$expte_beneficios; ?>&nbsp;</td>
        <td align="center" ><? if($expte_ubicacion == 'Sin definir ubicación') { echo "<img src='imagen/sindef.jpg'>"; }else echo $expte_ubicacion; ?>&nbsp;</td>
