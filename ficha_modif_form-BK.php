    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td width="25%"><select name="ficha_zona" id="ficha_zona">
            <option value="1" <? if ($ficha["ficha_zona"] == '1') { echo "selected=\"selected\""; } ?> >1</option>
            <option value="2" <? if ($ficha["ficha_zona"] == '2') { echo "selected=\"selected\""; } ?>>2</option>
            <option value="3" <? if ($ficha["ficha_zona"] == '3') { echo "selected=\"selected\""; } ?>>3</option>
            <option value="4" <? if ($ficha["ficha_zona"] == '4') { echo "selected=\"selected\""; } ?>>4</option>
          </select></td>
        <td width="16%"></td>
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td><input name="ficha_fecha" type="text" id="ficha_fecha" onkeypress="return pulsar(event)" onkeyup = "compUsuario(event)" size="10" maxlength="10" value="<?=$ficha["ficha_fecha"]; ?>"/></td>
        </tr>
        <tr>
        ...
        <tr>
          <td width="3%">SI</td>
          <td width="10%"><input name="entefectiva" type="radio" value="1" <? if ($ficha["ficha_ent_efect"] == '1') { echo "checked"; }?>></td>
          <td width="5%" align="center" bgcolor="#DFDFDF">NO</td>
          <td width="8%" bgcolor="#DFDFDF"><input name="entefectiva" type="radio" value="0" <? if ($ficha["ficha_ent_efect"] != '1') { echo "checked"; }?>></td>
          <td width="9%" bgcolor="#DFDFDF">Motivo: </td>
          <td bgcolor="#DFDFDF"><select name="noentefectiva_motivo">
          	<option value="0" <? if ($ficha["ficha_ent_efect_neg_motivo"] == '0') { echo "selected=\"selected\""; } ?>>Seleccione una...</option>
			<option value="1" <? if ($ficha["ficha_ent_efect_neg_motivo"] == '1') { echo "selected=\"selected\""; } ?>>Ausente</option>
			<option value="2" <? if ($ficha["ficha_ent_efect_neg_motivo"] == '2') { echo "selected=\"selected\""; } ?>>Rechazo</option>
			<option value="3" <? if ($ficha["ficha_ent_efect_neg_motivo"] == '3') { echo "selected=\"selected\""; } ?>>Vivienda vac&iacute;a</option>
			<option value="4" <? if ($ficha["ficha_ent_efect_neg_motivo"] == '4') { echo "selected=\"selected\""; } ?>>Local comercial</option>
			<option value="5" <? if ($ficha["ficha_ent_efect_neg_motivo"] == '5') { echo "selected=\"selected\""; } ?>>Lote bald&iacute;o</option>
			<option value="6" <? if ($ficha["ficha_ent_efect_neg_motivo"] == '6') { echo "selected=\"selected\""; } ?>>Vivienda en construcci&oacute;n</option>
			<option value="7" <? if ($ficha["ficha_ent_efect_neg_motivo"] == '7') { echo "selected=\"selected\""; } ?>>Equipamiento</option>
			<option value="8" <? if ($ficha["ficha_ent_efect_neg_motivo"] == '8') { echo "selected=\"selected\""; } ?>>Otros</option>
			</select>          </td>
          <td width="16%">&nbsp;</td>
          <td>&nbsp;</td>
        </tr>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td width="10%"><input name="ficha_cantviviendas" type="text" id="ficha_cantviviendas" onkeypress="return pulsar(event)" onkeyup = "compUsuario(event)" size="4" maxlength="8" value="<?=$ficha["ficha_viviendas_cant"]; ?>"/></td>
          <td width="7%">Letra:</td>
          <td width="11%"><input name="ficha_letra" type="text" id="ficha_letra" onkeypress="return pulsar(event)" onkeyup = "compUsuario(event)" size="4" maxlength="8" value="<?=$ficha["ficha_letra"]; ?>"/></td>
          <td width="20%">Cant.  hogares en la viv:</td>
          <td width="8%"><input name="ficha_canthogares" type="text" id="ficha_canthogares" onkeypress="return pulsar(event)" onkeyup = "compUsuario(event)" size="4" maxlength="8" value="<?=$ficha["ficha_hogares_cant"]; ?>"/></td>
          <td width="10%">Hogar Nro. </td>
          <td width="13%"><input name="ficha_hogar_num" type="text" id="ficha_hogar_num" onkeypress="return pulsar(event)" onkeyup = "compUsuario(event)" size="4" maxlength="8" value="<?=$ficha["ficha_hogares_num"]; ?>"/></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td colspan="7">&nbsp;</td>
              ...
              <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td>&nbsp;</td>
                    <td>Motriz</td>
                    <td><input name="ficha_p29" type="radio" value="1" <? if ($ficha["ficha_p29"] == '1') { echo "checked=\"checked\""; } ?>/></td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                    <td>Visual</td>
