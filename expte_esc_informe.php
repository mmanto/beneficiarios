...
$expte_esc_busqueda = $_POST["expte_esc_busqueda"];
...
<table border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="25" colspan="2" bgcolor="#F0F0F0"><h3><strong class="titulodato">Expediente de escrituraci&oacute;n N&ordm; <?=$resolucion_busqueda ?></strong> | <strong><a href="cert_cancelacion.php?expte_esc_busqueda=<?=$expte_esc_busqueda; ?>&<?=$linkvar ;?>" target="_blank">Ver certificado de cancelaci&oacute;n</a></strong> </h3></td>
  </tr>
  <tr>
    <td width="13">&nbsp;</td>
