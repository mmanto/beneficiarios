...
<table width="800" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td width="146" height="34" valign="middle">Resoluci&oacute;n de adjudic.: </td>
        <td width="103" height="34" valign="middle"><strong><?=$familia["Familia_res_adj"]; ?></strong></td>
        <td width="351" height="22" rowspan="2" align="right" valign="middle"><table width="350" border="0" cellpadding="7" cellspacing="0">
          <tr>
            <td width="131"><strong>Expte.  regularizaci&oacute;n: </strong></td>
            <td width="191"><?=$exptereg_caract; ?>-<?=$exptereg_num; ?>/<?=$exptereg_anio_res ?> <? if($exptereg_alcance != '0') {echo "Alc. ".$exptereg_alcance;}else{ echo " ";} ?> <? if ($exptereg_cuerpo != '0') {echo "Cpo ".$exptereg_cuerpo; }else{ echo " "; } ?>&nbsp;</td>
          </tr>
          <tr>
            <td><strong>Plano n&uacute;mero:</strong></td>
            <td><?=$familia["Plano_num"]; ?>&nbsp;</td>
          </tr>
          <tr>
      ...
      <tr>
        ...
        <td width="103" height="20" valign="middle">&nbsp;</td>
      </tr>
    </table>
        ...
        <tr>
		  ...
		  <? if ($idExpte!='0') { ?>
            <tr>
              ...
              <tr>
                <td colspan="3" bgcolor="#FFFFBB" height="1px"></td>
            </tr>
              <tr>
            ...
            <td width="23%" bgcolor="#FFFFBB">Expte. Nro.:</td>
            <td width="73%" bgcolor="#FFFFBB"><strong><?=$expte_caract; ?>-<?=$expte_num; ?>/<?=$expte_anio_res ?> <? if($expte_alcance != '0') {echo "Alc. ".$expte_alcance;} ?></strong></td>
          </tr>
              <tr>
                <td bgcolor="#FFFFBB">&nbsp;</td>
            <td bgcolor="#FFFFBB">Ubicaci&oacute;n:</td>
            <td bgcolor="#FFFFBB"><?=$expte_ubicacion; ?>&nbsp;</td>
          </tr>
              <tr>
                <td bgcolor="#FFFFBB">&nbsp;</td>
            ...
            <td colspan="2" align="center" valign="top" bgcolor="#FFFFBB"><a href="expte-informe.php?idExpte=<? echo $expte_nro; ?>&noback=0">[Ver detalles de movimientos del expte]</a></td>
            </tr>
              <tr>
                <td bgcolor="#FFFFBB" height="30"></td>
                <td colspan="2" align="center" valign="top" bgcolor="#FFFFBB"><? echo $familia["Expte_esc_obs"]; ?>&nbsp;</td>
              </tr>
            </table></td>
            </tr><? } ?>
            <tr>
	...
	<? if ($familia["Familia_beneficio_origen"]=='1') { ?>		
        ...
        <tr>
          <td height="20">Cantidad de cuotas:</td>
          <td><?=$familia_montoadj_cuotas; ?>&nbsp;</td>
        </tr>
        <tr>
	  ...
	  <table width="100%" border="0" cellspacing="0" cellpadding="3">
        ...
        <tr>
          <td width="18%"><strong>Alta del beneficio:</strong></td>
          <td width="34%"><strong><?=$familia["Nombre"] ?> (<?=$altabenef; ?>)</strong>&nbsp;</td>
          <td width="20%">Ultima modificaci&oacute;n: </td>
          <td width="28%"><? echo $usrModif["Nombre"]; ?> (<?=$modifbenef; ?>)&nbsp;</td>
        </tr>
        <tr>
          <td height="42" colspan="4" align="right" bgcolor="#FFFFFF">
