...
<table border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="24" colspan="4" valign="bottom"><a href="<? echo $origen; ?>">Volver</a> | <a href="informe_porbarrio_01.php?idBarrio=<?=$idBarrio;?>&criterio=<?=$criterio; ?>">Ver informe con observaciones</a>
