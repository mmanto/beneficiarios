...
$sql = "SELECT * FROM dbo_familia where Expte_reg_nro = '$expte_nro' AND blnActivo = '1' ORDER BY Lote_circunscripcion, Lote_seccion, Lote_chacra, Lote_quinta, Lote_manzana, Lote_parcela ASC";
$res = mysql_query($sql);
$cant = mysql_num_rows($res);


$sql3 = mysql_query("SELECT * FROM dbo_expte_reg WHERE Expte_nro = $expte_nro",$link);
