...
$res = "SELECT * FROM dbo_familia WHERE Barrio_nro = '$idBarrio' AND Familia_matricula = '0' AND Expte_esc_nro = '0' AND blnActivo = '1' ORDER BY Lote_manzana, Lote_parcela ASC";
/*
...
?>
<form method="post" action="superficie-asigna.php">
<table width="900" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td colspan="8" style="font-size:18px; font-weight:bold;">Partido: <?=$partido["Partido_nombre"]; ?> - Barrio: <? echo $barrio_nombre ?> - <?=$cant; ?> resultados</td>
  </tr>
  <tr>
    <td height="50" colspan="8"><a href="javascript:window.history.back();">[Volver al listdo de beneficiarios del barrio] </a></td>
  </tr>
  <tr>
    <td height="50" colspan="7" valign="top">Atención: el listado muestra únicamente aquellos beneficios que NO han sido escriturados ni están incluidos en un expediente de escrituración.</td>
    <td width="287" rowspan="6" valign="bottom"><table width="100%" border="0" cellspacing="0" cellpadding="13">
      <tr>
