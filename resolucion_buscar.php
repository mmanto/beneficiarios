...
?>
<form action="resolucion_informe.php" method="POST">
...
<table width="600" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td colspan="3"><h2>B&uacute;squeda de Beneficio por N&ordm; de Resoluci&oacute;n  </h2></td>
  ...
  <tr>
    <td valign="top"><strong>Ingrese n&uacute;mero de resoluci&oacute;n: </strong></td>
    <td height="30" valign="top"><input name="resolucion_busqueda" type="text" id="resolucion_busqueda" /></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
