...
$expte_esc_busqueda = $_GET["expte_esc_busqueda"];


/////////////////////////////////////////////////////
  
if (!$expte_esc_busqueda) {echo "<h2>Por favor, ingrese un n&uacute;mero de expediente;n</h2><p><a href=\"javascript:history.go(-1)\">Realizar una nueva b&uacute;squeda</a></p><p>&nbsp;</p>";

}else{

$sql = "SELECT Familia_nro, Lote_nro FROM dbo_familia where Expediente_esc_nro = '$expte_esc_busqueda'";
$res = mysql_query($sql);
...
<table border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td height="80" align="center"><strong>CERTIFICADO DE CANCELACION </strong></td>
  </tr>
  <tr>
    <td width="563" height="80" align="left">Certifico que los adjudicatarios consignados en el listado que abajo se detalla han cancelado el precio total del terreno convenido oportunamente en cada Resolución de Adjudicación respectiva, en el marco del Decreto 815/88, ubicados en el barrio “Billinghurst” del partido de San Martin.</td>
  </tr><tr>
    <td height="25"><table width="715" border="1" cellpadding="0" cellspacing="0" bordercolor="#999999">
      <tr>
