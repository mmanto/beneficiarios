    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
          <tr>
            <td height="32" colspan="2" align="center" >AAAAAA</td>
            </tr>
...
?>
  ...
  <tr>
    <td valign="top" <? if($b1_baja =='1' ) { echo "bgcolor=\"#EAE1E4\""; } if($b1_adj_pendiente =='1' ) { echo "bgcolor=\"#D0DCFB\""; }?> ><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td colspan="3">&nbsp;</td>
          <td width="43%" rowspan="13" valign="top">
            <?
              ...
              <tr>
                <td width="100%" height="22">          
                  <table width="100%" cellpadding="3" cellspacing="0">
                    ...
                    <? if($user["p732"]=='1') { ?>
                    <tr>
                      <td height="18" colspan="2" align="center" valign="top" bgcolor="#C9E3B0"><a href="tarjeta_pedido_reiteracion.php?idTarjeta=<?=$tarjeta["Tarjeta_nro"]; ?>&idFamilia=<? echo $persona_familia; ?>">[Reiterar solicitud de tarjeta]</a></td>
                    </tr><? } ?>                
                   <? if($user["p734"]=='1') { ?>                    
                    <tr>
                      <td height="18" colspan="2" align="center" valign="top" bgcolor="#C9E3B0"><a href="tarjeta-desasociar-confirm.php?idTarjeta=<?=$tarjeta["Tarjeta_nro"]; ?>&amp;idFamilia=<? echo $persona_familia; ?>">[Desasociar tarjeta]</a></td>
                    </tr>
                    <? } ?>
                    <tr>
                ...
                <a href="tarjeta-pagos-historial.php?idTarjeta=<? echo $tarjeta["Tarjeta_nro"]; ?>&idFamilia=<?=$familia["Familia_nro"]; ?>">[Ver historial de pagos]</a></td>        
                    ...
                    <tr>
                      <td height="18" colspan="2" align="center" valign="top" bgcolor="#C9E3B0"><a href="detalle-contable-individual.php?idTarjeta=<? echo $tarjeta["Tarjeta_nro"]; ?>&idFamilia=<?=$familia["Familia_nro"]; ?>">[Imprimir detalle contable]</a></td>
                    </tr>
                    <tr>
