...
<input type="hidden" name="user_nivel" value="<? echo $log_nivel; ?>" onkeypress="return pulsar(event)"/>
  ...
  <tr>
	...
	<table width="600" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="82" height="24" valign="bottom"  >No. Partido</td>
        <td width="307" valign="bottom"  >Barrio</td>
        <td width="118" height="16" valign="bottom"  > Env&iacute;o a EGG </td>
        <td width="93" valign="bottom">Cant. beneficios </td>
      </tr>
      <tr>
        <td><input name="idPartido" type="text"  id="idPartido" size="8" value="<?=$expte_partido; ?>" onkeypress="return pulsar(event)" /></td>
...
<? if($barrio_nro == $expte_barrio) { ?>selected="selected"<? } ?>><?=$barrio_partido; ?> - <?=$barrio_nombre; ?></option>
  <? } ?>
        ...
        <td><input name="expte_envio_egg" type="text" id="expte_envio_egg" size="8" value="<?=$expte_envio_egg; ?>"  onkeypress="return pulsar(event)"/>
        &nbsp;</td>
        <td><input name="expte_beneficios" type="text" id="expte_beneficios" size="4" value="<?=$expte_beneficios; ?>" onkeypress="return pulsar(event)"/>
        &nbsp;</td>
      </tr>
      <tr>
        <td>&nbsp;</td>
