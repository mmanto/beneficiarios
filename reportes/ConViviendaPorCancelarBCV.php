...
class ConViviendaPorCancelarBCV extends TCPDF{
    ...
    private $cuotas_calculadas;
    
    private $cuotas_automaticas_txt;
    ...
    public function carga_datos($familia_decreto_compra,
        ...
        $monto_cuota){ // -----------------
            ...
            $contenido = '<p style="text-align:justify">En la localidad de ' . $localidad . ", " . trim($fecha) . ", por una parte la Municipalidad de " . $ente_municipal   .
            " representada en este acto por el Sr. Intendente Municipal, " . $intendente_nombre . ", con domicilio en la calle " . $intendente_domicilio .
	    ...
	    $cant_integrantes = count( $integrantes );
			...
			", con domicilio en calle " . $familia_domic . ", en adelante EL COMPRADOR,  ";
		}else{
			...
			$str_contraparte .= ', en adelante el COMPRADOR '; 
		}
	    ...
	    $plano_registrado = $this->plano_registrado;
	    
	   
            $clausula_1A = '<p style="text-align:justify"><b>CLÁUSULA 1.-</b> La MUNICIPALIDAD vende al COMPRADOR una parcela identificada catastralmente como <b>' . $nomencla .
            "</b>, partido de " . $partido_nombre . "(" . $partido_nro . ")" .
            ...
            ", " . $plano_registrado . " y entrega en este acto la posesión de la misma.</p>";
            ...
            $clausula_1B = '<p style="text-align:justify" >' . 'La presente compraventa se realiza en el marco del "Programa Familia Propietaria", representado en este acto por el' .
                " Subsecretario de Hábitat de la Comunidad, conforme a lo estipulado por Decreto " . $familia_decreto_compra . 
		...
		$plan_vivienda_nombre = utf8_encode( $item_planvivienda['Planvivienda_nombre'] );
		
		//var_dump($item_planvivienda);
		
		if ($planvivienda_nro == 1 or $planvivienda_nro == 4){
	    
			$clausula_1C = '<p style="text-align:justify">' .
			'En la parcela entregada se encuentra edificada una vivienda construida a través del programa '. $plan_vivienda_nombre .', ' .
            ...
            $clausula_2 = '<p style="text-align:justify"><b>CLÁUSULA 2.-</b> El monto del terreno se fija en la suma de ' . $monto . "($ " . $monto_terreno . ".-)" . " correspondiente al monto total de la operación incluida la escritura-.</p>";
            	    
            $cuotas_letras = str_replace( " pesos ", "", $cifra->traducir( $cant_cuotas ) );
            
            // Test
	    //echo 'monto terreno: ' . $monto_terreno . '<br>';
	    //echo 'cantidad cuotas: ' . $cant_cuotas . '<br>';
	    //echo 'valor de cada cuota: ' . round ($monto_terreno / $cant_cuotas, 2);
	    //$monto_cuota = $monto_terreno / $cant_cuotas;
	    $monto_cuota = bcdiv ($monto_terreno, $cant_cuotas, 2);
	    $monto_cuota_letras = $cifra->traducir( $monto_cuota );            
	    
	    if($this->cuotas_calculadas){
		$clausula_3 = "<p><b>CLÁUSULA 3.-</b> El COMPRADOR se compromete a pagar la parcela en ". $cuotas_letras . "(" . $cant_cuotas .") cuotas mensuales, iguales y consecutivas de ". $monto_cuota_letras .
		"($ " . $monto_cuota. ") pagaderas de 1 al 10 de cada mes, venciendo la primera el mes de ". $vencimiento_primera_cuota . ". Se deja constancia en caso de corresponder, que serán válidos todos los pagos efectuados por el beneficiario al Municipio por la parcela de referencia con anterioridad a la firma del presente Boleto de Compraventa.-</p>";	
	    }else{
		$clausula_3 = "<p><b>CLÁUSULA 3.- </b>".
		$this->cuotas_automaticas_txt .
		"</p>";
	    }
            ...
            $clausula_4 = '<p style="text-align:justify"><b>CLÁUSULA 4.-</b> Los importes correspondientes a los pagos mensuales que el COMPRADOR abone ingresarán al Fondo Municipal de la Vivienda ' .
                "para ser reinvertidos en la compra de tierras o mejoramiento de infraestructura básica de los lotes del Programa Familia Propietaria.-</p>";
            $clausula_5 = '<p style="text-align:justify"><b>CLÁUSULA 5.-</b> La escritura traslativa de dominio con cláusula hipotecaria se tramitará por ante la Escribanía General de Gobierno de la Provincia de Buenos Aires.-</p>';
            
            $clausula_6 = '<p style="text-align:justify"><b>CLÁUSULA 6.-</b> El COMPRADOR se compromete a destinar el inmueble a vivienda única y de ocupación permanente del grupo familiar, ' .
            ...
            $clausula_8 =  '<p style="text-align:justify"><b>CLÁUSULA 8.-</b> La MUNICIPALIDAD sólo reconocerá como legítimo comprador al que figura en el presente boleto de compraventa, siendo el único ' .
                "con derecho a obtener la escritura traslativa de dominio, a través de la Escribanía General de Gobierno en el marco de lo estipulado en el Programa Familia propietaria.-</p>";
            $clausula_9 = '<p style="text-align:justify"><b>CLÁUSULA 9.-</b> La RENUNCIA al Programa Familia Propietaria , será el único medio a través del cual podrá llevarse a cabo la devolución del inmueble. ' .
                "En este caso la MUNICIPALIDAD procederá a devolverle al COMPRADOR los importes en la misma forma y tiempo en que fueron abonados y " .
                "readjudicará el terreno a quien siga en orden de mérito en el listado de suplentes.-</p>";
            
            $clausula_10 = '<p style="text-align:justify"><b>CLÁUSULA 10.-</b> Ante el incumplimiento de lo estipulado en el presente la MUNICIPALIDAD se reserva el derecho a exigir la devolución '.
                "de la parcela sin necesidad de interpelación judicial alguna, sometiendo las partes a la jurisdicción de los Tribunales Ordinarios de " . $this->tribunales ."</p>";
            
            $clausula_10A = '<p>Refrenda el presente, la Subsecretaria de Hábitat de la Comunidad, habiéndose ratificado lo actuado a través de la Dirección de Seguimiento de Intervenciones Complementarias '.
                "(Programa Familia Propietaria) dependiente de la Dirección Provincial de Producción de Hábitat, por haberse cumplido con el Convenio oportunamente suscripto." ."</p>";
            
            $clausula_10B = '<p>En prueba de conformidad y aprobación, se firma el presente en tres (3) ejemplares de un mismo tenor y a un solo efecto en la localidad y fecha "ut-supra" mencionadas.-</p>';
    ...
    function ejecutar_consultas( $familias ){
		...
		$familia_decreto_compra = $this->tiene_valor($item,"Familia_decreto_compra");
                ...
                $this->carga_datos($familia_decreto_compra,
		    $planvivienda_nro,
     ...
     */
    function datos_comun($tribunales, $localidad_boleto, $fecha_letras, $vencimiento_primera_cuota, $plano_registrado , $cuotas_calculadas ,$cuotas_automaticas_txt){
	...
	$this->cuotas_calculadas = $cuotas_calculadas;
	
	$this->cuotas_automaticas_txt = $cuotas_automaticas_txt;
