...
class AdjudicacionBCV extends TCPDF{
	...
	$planvivienda_nro,
	    ...
	    ' &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;La Subsecretaría Social de Tierras, y Acceso Justo al Hábitat del Ministerio de Desarrollo Social de la Provincia de Buenos Aires,' . 
	    
	    ' CERTIFICA que mediante la Resolución '. $res_adj . ' del Ministerio de Desarrollo Social, el inmueble '. 
...
*/
	...
	' notifico de la Resolución '. $res_adj . ' dictada por el entonces Ministro de Desarrollo Social '.
	...
	' Partido de '. $partido_nombre.' recibiendo copia de la misma.'.
	'</p>';
