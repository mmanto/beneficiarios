...
class SinViviendaPorCancelarBCV extends TCPDF{
 ...
 /*           $clausula_1C = "";
	    ...
	    $clausula_3 = "<p><b>CLÁUSULA 3.-</b> El COMPRADOR se compromete a pagar la parcela en ". $cuotas_letras . "(" . $cant_cuotas .") cuotas mensuales y consecutivas según detalla para cada caso el Anexo I del Decreto Municipal 392/18, las que serán pagaderas de 1 al 10 de cada mes, venciendo la primera el mes de ". $vencimiento_primera_cuota . " del corriente año. Se deja constancia en caso de corresponder, que serán válidos todos los pagos efectuados por el beneficiario al Municipio por
la parcela de referencia con anterioridad a la firma del presente Boleto de Compraventa.-</p>";
            ...
            $clausula_10A = '<p>Refrenda el presente, la Subsecretaria Social de Tierras y Acceso Justo al Hábitat, habiéndose ratificado lo actuado a través de la Dirección de Urbanizaciones Sociales '.
