...
class SinViviendaCanceladoBCV extends TCPDF{
    ...
    public function carga_datos($familia_decreto_compra,
            ...
            " representada en este acto por el Sr. Intendente Municipal, " . $intendente_nombre . ", con domicilio en calle " . $intendente_domicilio .
	    ...
	    $cant_integrantes = count( $integrantes );
			...
			foreach( $integrantes as $key=>$integrante ){
				...
				", con domicilio en calle " . $familia_domic  ;  
	...
	$plano_registrado = $this->plano_registrado;
            ...
            $clausula_1A = '<p style="text-align:justify"><b>CLÁUSULA 1.-</b> La MUNICIPALIDAD vende al ' . $plural_singular_comprador .' una parcela identificada catastralmente como <b>' . $nomencla .
  ...
  /*          $clausula_1C = "";
		...
		if ($planvivienda_nro == 1 or $planvivienda_nro == 4){
            ...
            $clausula_2 = '<p style="text-align:justify"><b>CLÁUSULA 2.-</b> El monto del terreno se fija en la suma de ' . $monto . "($" . $monto_terreno . ".-)" . " correspondiente al monto total de la operación " . 
	    "incluida la escritura, el cual se encuentra cancelado en su totalidad al día de la fecha.-.</p>";
	    ...
	    /*
            ...
            */
            ...
            $clausula_3 = '<p style="text-align:justify"><b>CLÁUSULA 3.-</b> Los importes correspondientes al pago que ' . $plural_singular_comprador .' abonó, ingresarán al Fondo Municipal de la Vivienda ' .
            ...
            $clausula_4 = '<p style="text-align:justify"><b>CLÁUSULA 4.-</b> La escritura traslativa de dominio se tramitará por ante la Escribanía General de Gobierno de la Provincia de Buenos Aires.-</p>';
            
            $clausula_5 = '<p style="text-align:justify"><b>CLÁUSULA 5.-</b> ' . ucfirst($plural_singular_comprador) . '  se compromete a que la construcción a edificarse en la parcela, será destinada a vivienda única y de ocupación permanente del grupo familiar, ' .
	        " debiendo construírse de acuerdo a lo normado por el Municipio conforme al mínimo constructivo estipulado para cada barrio, ".
                " declarando expresamente no poseer propiedad alguna bajo pena de resolución por falsedad de datos.-</p>";
            
            $clausula_6 = '<p style="text-align:justify"><b>CLÁUSULA 6.-</b> El presente boleto de compraventa es de carácter INTRANSFERIBLE por el termino de cinco (5) años, contados a partir de su firma. ' .
                "La MUNICIPALIDAD no aceptará como válida ningún tipo de cesión o venta entre particulares.-</p>";
            $clausula_7 =  '<p style="text-align:justify"><b>CLÁUSULA 7.-</b> La MUNICIPALIDAD reconocerá como legítimo comprador al que figura en el presente boleto de compraventa, siendo el unico ' .
            ...
            $clausula_8 = '<p style="text-align:justify"><b>CLÁUSULA 8.-</b> La RENUNCIA al Programa Familia Propietaria será el único medio a través del cual podrá llevarse a cabo la restitución de la parcela. ' .
                "En este caso la MUNICIPALIDAD procedera a devolverle a EL COMPRADOR los importes en la misma forma y tiempo en que fueron abonados y " .
                "readjudicará el terreno a quien siga en orden de mérito en el listado de suplentes.-</p>";

/*
            $clausula_9 = '<p style="text-align:justify"><b>CLÁUSULA 9.-</b> Se deja constancia que el presente Boleto de Compraventa se subscribe por Decreto Municipal de adjudicación y desadjudicación N°' . 
	    '1949/2016 dejando si validez y efecto alguno al boleto de la fecha [fecha_boleto_previo], subscripto oportunamente por la Señora [nombre_señora] - [DNI], sobre el inmueble objeto del presente.</p>';
*/	    
	    $clausula_9 = '<p style="text-align:justify"><b>CLÁUSULA 9.-</b> Ante el incumplimiento de lo estipulado en el presente la MUNICIPALIDAD se reserva el derecho a exigir la restitución '.
            ...
            $clausula_9A = '<p>Refrenda el presente, la Subsecretaría de Hábitat de la Comunidad, habiéndose ratificado lo actuado a través de la Dirección de Seguimiento de Intervenciones Complementarias '.
                "(Programa Familia Propietaria) dependiente de la Dirección Provincial Producción de Hábitat, por haberse cumplido con el Convenio oportunamente suscripto." ."</p>";
            
            $clausula_9B = '<p>En prueba de conformidad y aprobación, se firma el presente en tres (3) ejemplares de un mismo tenor y a un solo efecto en la localidad y fecha "ut-supra" mencionadas.-</p>';
            
            $this->contenido[] =  $titulo . $contenido .$str_contraparte . $clausula_1A . $clausula_1B . $clausula_2 . $clausula_3 . $clausula_4 . $clausula_5 . $clausula_6 . $clausula_7 . $clausula_8 . $clausula_9 . $clausula_9A . $clausula_9B;
