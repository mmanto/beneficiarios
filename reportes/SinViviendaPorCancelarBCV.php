...
class SinViviendaPorCancelarBCV extends TCPDF{
	...
	$planvivienda_nro,
	    ...
	    $plano_registrado = $this->plano_registrado;
            ...
            $clausula_1B = '<p style="text-align:justify" >' . 'La presente compraventa se realiza en el marco del "Programa Familia Propietaria", representado en este acto por el' .
                " Subsecretario de Hábitat de la Comunidad, conforme a lo estipulado por la Unidad Ejecutora y Coordinadora del Programa Familia Propietaria de la Provincia de Buenos Aires y la MUNICIPALIDAD.</p>";
 ...
 /*           $clausula_1C = "";
		...
		"($ " . $monto_cuota. ") pagaderas de 1 al 10 de cada mes, venciendo la primera el mes de ". $vencimiento_primera_cuota . " de 2021. Se deja constancia en caso de corresponder, que serán válidos todos los pagos efectuados por el beneficiario al Municipio por
		la parcela de referencia con anterioridad a la firma del presente Boleto de Compraventa.-</p>";
	    }else{
		...
		"</p>";
            ...
            $clausula_5 = '<p style="text-align:justify"><b>CLÁUSULA 5.-</b> La escritura traslativa de dominio se tramitará por ante la Escribanía General de Gobierno de la Provincia de Buenos Aires, tras la cancelación de la deuda.-</p>';
            ...
            $clausula_10A = '<p>Refrenda el presente, la Subsecretaría de Hábitat de la Comunidad, habiéndose ratificado lo actuado a través de la Dirección de Seguimiento de Intervenciones Complementarias '.
     ...
     */
    function datos_comun($tribunales, $localidad_boleto, $fecha_letras, $vencimiento_primera_cuota, $plano_registrado, $cuotas_automaticas, $cuotas_automaticas_txt){
	...
	$this->cuotas_automaticas = $cuotas_automaticas;
