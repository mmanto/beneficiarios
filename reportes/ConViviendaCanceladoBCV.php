...
class ConViviendaCanceladoBCV extends TCPDF{
	...
	$num_decreto){ // -----------------
            ...
            " representada en este acto por el Sr. Intendente Municipal, " . $intendente_nombre . ", con domicilio en " . $intendente_domicilio .
	    ...
	    $plano_registrado = $this->plano_registrado;
            ...
            $clausula_1B = '<p style="text-align:justify" >' . 'La presente compraventa se realiza en el marco del "Programa Familia Propietaria", representado en este acto por el' .
                " Subsecretario de Hábitat de la Comunidad, conforme a lo estipulado por decreto " . $num_decreto . ", " .
		...
		if ($planvivienda_nro == 1 or $planvivienda_nro == 4){
			...
			'En la parcela entregada se encuentra edificada una vivienda construida a través del programa ' .
			$item_planvivienda['Planvivienda_nombre'] . ', ' .
	    ...
	    //echo "numero plan vivienda: " . $planvivienda_nro;
	    ...
	    /*
            ...
            */
            ...
            $clausula_3 = '<p style="text-align:justify"><b>CLÁUSULA 3.-</b> Los importes correspondientes a los pagos mensuales que el COMPRADOR abonó ingresarán al Fondo Municipal de la Vivienda ' .
            ...
            $clausula_4 = '<p style="text-align:justify"><b>CLÁUSULA 4.-</b> La escritura traslativa del dominio con cláusula hipotecaria se tramitará por ante la Escribanía General de Gobierno de la Provincia de Buenos Aires.-</p>';
            
            $clausula_5 = '<p style="text-align:justify"><b>CLÁUSULA 5.-</b> El COMPRADOR se compromete a destinar el inmueble a vivienda única y de ocupación permanente del grupo familiar, ' .
            ...
            $clausula_8 = '<p style="text-align:justify"><b>CLÁUSULA 8.-</b> La RENUNCIA al Programa Familia Propietaria , será el único medio a través del cual podrá llevarse a cabo la devolución del inmueble. ' .
            ...
            $clausula_9 = '<p style="text-align:justify"><b>CLÁUSULA 9.-</b> Ante el incumplimiento de lo estipulado en el presente la MUNICIPALIDAD se reserva el derecho a exigir la devolución '.
            ...
            $clausula_9B = '<p>En prueba de conformidad y aprobación, se firmará el presente en tres (3) ejemplares de un mismo tenor y a un solo efecto en la localidad y fecha "ut-supra" mencionadas.-</p>';
            
            $this->contenido[] =  $titulo . $contenido .$str_contraparte . $clausula_1A . $clausula_1B . $clausula_1C . $clausula_2 . $clausula_3 . $clausula_4 . $clausula_5 . $clausula_6 . $clausula_7 . $clausula_8 . $clausula_9 . $clausula_9A . $clausula_9B; 
    ...
    function ejecutar_consultas( $familias ){
	    ...
	    $nomencla = $circunscripcion . $seccion . $quinta . $chacra . $fraccion . $manzana . $parcela . $subparcela;
		    ...
		    $this->tiene_valor($item, "Familia_decreto_compra") 	);
        }
