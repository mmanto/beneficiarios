...
<table width="730" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td><table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#999999">
      <tr>
        <td width="50" height="25" align="center" class="titulo_dato">Id.</td>
        <td width="257" align="center" class="titulo_dato">Partido</td>
        <td width="222" align="center" class="titulo_dato">Barrio</td>
        <td width="177" align="center" class="titulo_dato">Acciones</td>
        </tr>
<?
...
?>
      <tr>
        ...
        <td align="center" ><a href="beneficio_alta_porbarrio_form.php?idBarrio=<?=$barrio["Barrio_nro"]; ?>">Dar de alta beneficiarios</a></td>
        </tr>
