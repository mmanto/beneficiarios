...
<table width="600" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td valign="top"><strong>Ingrese el n&uacute;mero de nota: </strong></td>
    <td height="30" valign="top"><input name="nota_num" type="text" value="<?=$nota_num; ?>" /></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td><input name="cmdLogin" type="submit" id="cmdLogin" value="Actualizar"></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td height="35">&nbsp;</td>
