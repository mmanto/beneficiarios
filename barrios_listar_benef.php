...
?>
      <tr>
        ...
        <td width="31" align="center" ><a href="beneficio_porbarrio_listar.php?idBarrio=<?=$barrio["Barrio_nro"]; ?>&criterio=0"><img src="imagen/benef.jpg" border="0" /></a></td>
        <td width="28" align="center" ><? if($user["HabSbt"]< 5) { ?><a href="beneficio_alta_porbarrio_form.php?idBarrio=<?=$barrio["Barrio_nro"]; ?>"><? } ?><img src="imagen/benef-add.jpg" border="0" /></a></td>
