...
) WHERE Expte_origen = '1' ORDER BY Expte_barrio ASC",$link);
...
<table border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td><table width="760" border="1" cellpadding="0" cellspacing="0" bordercolor="#999999">
      <tr>
        <td width="40" height="25" align="center" class="titulo_dato">Id.</td>
        <td width="135" align="center" class="titulo_dato">Expediente</td>
        <td width="150" align="center" class="titulo_dato">Partido</td>
        <td width="126" align="center" class="titulo_dato">Barrio</td>
        <td width="76" align="center" class="titulo_dato">Beneficios</td>
        <td width="97" align="center" class="titulo_dato">Env&iacute;o EGG</td>
...
?>
      <tr>
        <td height="30" align="center" ><?=$expte_nro ;?></td>
        ...
        <td width="29" align="center" ><img src="imagen/doc.png" alt="Ver informe expte." width="11" height="16" border="0" /></td>
        <td width="25" align="center" class="datos-center"><a href="expte_esc_modif_form.php?id=<? echo $expte_nro;?> "><img src="imagen/edit.png" alt="Editar expte." title="Editar expte." width="16" height="16" border="0" /></a></td>
        <td width="26" align="center"><a href="beneficio_expte_listar.php?expte=<? echo $expte_nro; ?>"><img src="imagen/benef.jpg" alt="Listar beneficiarios" title="Listar beneficiarios" width="16" height="19" border="0" /></a></td>
        <td width="34" align="center"><a href="beneficio_expte_alta_form.php?expte=<? echo $expte_nro; ?>"><img src="imagen/benef-add.jpg" alt="Incorporar beneficiarios" title="Incorporar beneficiarios" width="16" height="19" border="0" /></a></td>
      </tr>
