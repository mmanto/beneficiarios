...
<table width="750" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="16" colspan="4"><a href="barrios_listar_partido.php?idPartido=<?=$idPartido; ?>">Volver al listado de barrios </a></td>
    </tr>
  <tr>
    <td width="5" rowspan="2">&nbsp;</td>
    <td width="118" height="46" valign="bottom" style="font-size:14px; font-weight:bold;">Partido:</td>
    <td colspan="2" valign="bottom" style="font-size:14px; font-weight:bold;"><? echo $partido["Partido_nombre"]; ?></td>
    </tr>
  <tr>
    <td height="46" style="font-size:14px;"><strong>Nombre: </strong></td>
    <td colspan="2"><input name="barrio_nombre" type="text" id="barrio_nombre" size="20" value="<?=$barrio["Barrio_nombre"]; ?>" style="font-size:14px;"/></td>
  </tr>
  <tr>
    <td width="5">&nbsp;</td>
    <td valign="middle">&nbsp;</td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td height="30" bgcolor="#DFE7EE">&nbsp;Circunscripci&oacute;n</td>
    <td width="122" height="30" bgcolor="#DFE7EE"><input name="barrio_circ" type="text" id="barrio_circ" value="<?=$barrio["Barrio_circunscripcion"]; ?>"size="12" /></td>
    <td width="80">&nbsp;</td>
    <td width="79">&nbsp;</td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td height="30" bgcolor="#DFE7EE">&nbsp;Secci&oacute;n:</td>
    <td height="30" bgcolor="#DFE7EE"><input name="barrio_secc" type="text" id="barrio_secc" value="<?=$barrio["Barrio_seccion"]; ?>" size="12" /></td>
    <td height="30">&nbsp;</td>
    <td>&nbsp;</td>
...
(dd/mm/aaaa)</td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td height="30" bgcolor="#DFE7EE">&nbsp;Chacra:</td>
    <td height="30" bgcolor="#DFE7EE"><input name="barrio_ch" type="text" id="barrio_ch" value="<?=$barrio["Barrio_chacra"]; ?>" size="12" /></td>
    <td height="30">&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td height="30" bgcolor="#DFE7EE">&nbsp;Quinta:</td>
    <td height="30" bgcolor="#DFE7EE"><input name="barrio_qta" type="text" id="barrio_qta" value="<?=$barrio["Barrio_quinta"]; ?>" size="12" /></td>
    <td height="30">&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td height="30" bgcolor="#DFE7EE">&nbsp;Fracci&oacute;n:</td>
    <td height="30" bgcolor="#DFE7EE"><input name="barrio_fracc" type="text" id="barrio_fracc" value="<?=$barrio["Barrio_fraccion"]; ?>"  size="12" /></td>
    <td height="30">&nbsp;</td>
    <td>&nbsp;</td>
...
&nbsp;(dd/mm/aaaa)</td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td height="30" valign="middle"><strong>Decreto compra:</strong></td>
    <td><input name="decreto_compra" type="text" id="decreto_compra" value="<?=$barrio["Barrio_decreto_compra"]; ?>" size="12" /></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><strong>Plan de vivienda:</strong></td>
    <td>
    <select name="planvivienda" id="planvivienda">
