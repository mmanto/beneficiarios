...
$sql = "SELECT Familia_nro, Familia_apellido, Familia_res_adj, Lote_nro FROM dbo_familia where Barrio_nro = '$idBarrio' ORDER BY Familia_nro ASC";
$res = mysql_query($sql);
...
?><table border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="25" colspan="2" bgcolor="#F0F0F0"><h3><strong class="titulodato">Barrio: <? echo $barrio_nombre ?> (<? echo $barrio_partido; ?>)</strong></h3></td>
  </tr>
  <tr>
    <td width="13">&nbsp;</td>
  ...
  <tr>
    ...
    <td width="82" class="titulo_dato">Resolucion</td>
  </tr>
