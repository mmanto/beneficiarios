...
$pdf->WriteFlowingBlock( "\t\t\t\t\t\t\t\t\t\t\t\t" );
$pdf->SetFont( $tipoDeLetra, '', $tamanio_letra_texto );
$pdf->WriteFlowingBlock( "La adjudicación se ha producido en el marco del Decreto 2225/95 por lo cual los adjudicatarios deben cumplir con las obligaciones allí dispuestas bajo apercibimiento, en caso de incumplimiento, de dar de baja la adjudicación y readjudicar el inmueble a otros beneficiarios." );
$pdf->finishFlowingBlock();
