...
if($direccion_destino == '99') { $expte_mov_salida = '1'; }else{ $expte_mov_salida = '0';}
...
// Si el �rea de destino es 83 (Gestion Escrituraria) Expte_esc = 1;
...
<meta name="author" content="Andr�s J. Bilstein">
<style type="text/css">
<!--
body {
	margin-left: 50px;
