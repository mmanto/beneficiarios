...
<table width="730" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="563" align="left">aaa&nbsp;
      <table width="100%" border="0" cellpadding="7" cellspacing="0" bgcolor="#FFFF66">
        <tr>
          <td>Atenci&oacute;n: Para poder dar de alta a un nuevo expediente &eacute;ste debe pertenecer a un barrio. Si a&uacute;n no fue incorporado el barrio, puede hacerlo desde aqu&iacute; <a href="barrio_alta_form.php?origen=<?=basename($_SERVER['PHP_SELF']); ?>">[Dar de alta nuevo barrio] </a></td>
        </tr>
      </table></td>
  </tr>
  <tr>
...
?>
      <tr>
        ...
        <td width="28" align="center" ><a href="exptes_listar_porbarrio.php?idBarrio=<?=$barrio["Barrio_nro"]; ?>"><img src="imagen/expte.jpg" border="0" /></a></td>
        <td width="28" align="center" ><a href="expte_esc_alta_form.php?idBarrio=<?=$barrio["Barrio_nro"]; ?>"><img src="imagen/expte-add.jpg" border="0" /></a></td>
        </tr>
