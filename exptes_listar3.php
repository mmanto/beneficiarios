...
INNER JOIN
dbo_partido
ON dbo_expte_esc_BK20161101.idPartido = dbo_partido.Partido_nro) WHERE Expte_envio_egg > '2016-01-01' ORDER BY $orden",$link);
...
<tr>
  ...
  <tr>
    ...
    <td height="25">&nbsp;</td>
    <td>
	<table width="657" border="1" cellpadding="0" cellspacing="0" bordercolor="#999999">
      <tr>
