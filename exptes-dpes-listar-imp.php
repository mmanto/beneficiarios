...
<table border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="24" colspan="2" valign="bottom"><a href="exptes-dpes-listar.php">Volver</a></td>
  </tr>
  <tr>
  ...
  <tr>
    <td height="4" colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="3">
	  ...
	  <option value="<?=basename($_SERVER['PHP_SELF']); ?>?ordenar=envioegg" <? if ($ordenar == 'envioegg') { ?> selected="selected" <? } ?>>Envio a EGG</option>
        ...
        <td width="59%"><a href="exptes-dpes-listar-imp.php"></a></td>
      </tr>
    </table></td>
        </tr>
    </table></td>
...
?>
      <tr>
		...
		<? if($expte["Expte_extracto"] == "COMPLETAR EXTRACTO") { echo "<img src='imagen/alerta.png'>"; } ?>		</td>
