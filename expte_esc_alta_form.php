...
<input name="idPartido" type="hidden" id="idPartido" value="<?=$idPartido; ?>"/>
  ...
  <tr>
	...
	<table width="600" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="189" height="24" valign="bottom"  >Salida a </td>
        <td width="62" valign="bottom"  >&nbsp;</td>
        <td width="152" height="16" valign="bottom"  >Fecha salida </td>
        <td width="197" valign="bottom">Cant. beneficios </td>
      </tr>
      <tr>
        <td colspan="2"><select name="expte_destino" id="expte_destino">
		<option value="0" selected="selected">Seleccione el destino...</option>
		<option value="1">Escribania General de Gobierno</option>
		<option value="2">Municipalidad</option>
		<option value="3">Ministerio de Infraestructura</option>
		<option value="4">Instituto de la vivienda</option>
		<option value="5">Subsecretaría Social de Tierras</option>		
              </select></td>
	...
	<table width="600" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="252" height="24" valign="bottom"  >Ultimo movimiento </td>
