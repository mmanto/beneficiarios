...
$sql3 = mysql_query("SELECT * FROM dbo_exptes WHERE Expte_ubicacion_area = '23' AND blnActivo = '1' ORDER BY $orden",$link);
...
<table width="900" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td height="9" colspan="2"><h1>Expedientes en archivo (cant: <?=$cant; ?>) </h1></td>
  </tr>
  <tr>
  ...
  <tr>
	...
	<table width="900" border="0" cellpadding="4" cellspacing="5">
      <tr>
        <td width="45" height="24" align="center" bgcolor="#D2D8BC" class="titulo_dato">Caract.</td>
		  <td width="29" align="center" bgcolor="#D2D8BC" class="titulo_dato">Pdo.</td>
		  <td width="43" align="center" bgcolor="#D2D8BC" class="titulo_dato">RNRD</td>
		  <td width="50" align="center" bgcolor="#D2D8BC" class="titulo_dato">N&uacute;mero</td>
		  <td width="26" align="center" bgcolor="#D2D8BC" class="titulo_dato">A&ntilde;o</td>
          <td width="25" align="center" bgcolor="#D2D8BC" class="titulo_dato">Alc.</td>
          <td width="37" align="center" bgcolor="#D2D8BC" class="titulo_dato">Cpos.</td>
          <td width="410" align="center" bgcolor="#D2D8BC" class="titulo_dato">Extracto</td>
          <td colspan="2" align="center" bgcolor="#D2D8BC" class="titulo_dato">Acciones</td>
          <td align="center" bgcolor="#D2D8BC"><input type="checkbox" onclick="marcar(this);" /></td>
        </tr>
  <?
$num_fila = '0'; 
...
?>
      <tr <? if ($num_fila%2==0) { echo "bgcolor=\"#EBEDE0\""; }else{ echo "bgcolor=\"#E2E4D3\"";} ?>>
        <td align="center" ><?=$expte_caract; ?></td>
         ...
         <td width="41" align="center"><? if ($user["HabExp"] <= '4') { ?> <input type="checkbox" name="seleccion[]" value="<?=$expte["Expte_nro"]; ?>" /><? }else{ ?> - <? } ?></td>
        </tr>
	  ...
	  <tr>
	    <td colspan="11" align="right"><? if ($user["HabExp"] <= '4') { ?><table width="98%" border="0" cellspacing="0" cellpadding="5">
          <tr>
            <td height="45" colspan="3" align="center" bgcolor="#E2E4D3"><h2>Efectuar el pase de los expedientes marcados a Mesa de entradas (desarchivo) </h2></td>
            <td width="14%" bgcolor="#E2E4D3">
          ...
          <tr>
            <td width="27%" height="45" align="right" valign="top" bgcolor="#E2E4D3">Observaciones sobre el pase: </td>
            <td width="41%" bgcolor="#E2E4D3"><textarea name="pase_observaciones" cols="50" rows="2" id="pase_observaciones"></textarea></td>
            <td colspan="2" bgcolor="#E2E4D3"><input type="submit" name="Submit" value="Confirmar pase" /></td>
            </tr>
          <tr>
            <td align="right" bgcolor="#E2E4D3">&nbsp;</td>
            <td bgcolor="#E2E4D3">&nbsp;</td>
            <td width="18%" bgcolor="#E2E4D3">&nbsp;</td>
            <td bgcolor="#E2E4D3">&nbsp;</td>
          </tr>
        </table>
	    <? } ?></td>
