...
<table width="900" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td height="9" colspan="2"><h1>Expedientes ingresados al sistema el día <? echo cambiaf_a_normal($fecha); ?></h1></td>
  </tr>
  <tr>
    <td width="778" height="6">Listado de expedientes que han ingresado desde otro organismo o han sido dados de alta en la fecha indicada.</td>
    <td width="122">&nbsp;</td>
  </tr>
  <tr>
  ...
  <tr>
    <td height="36" colspan="2" valign="bottom"><h2>Expedientes ingresados al organismo (cant: <?=$cant; ?>)</h2></td>
  </tr>
  <tr>
...
<tr>
    <td height="36" colspan="2" valign="bottom"><h2>Expedientes dados de alta (cant: <?=$cant2; ?>)</h2></td>
  </tr>
  <tr>
    <td height="6" colspan="2" valign="bottom">&nbsp;</td>
  </tr>
...
?>
  ...
  <tr>
    <td height="36" colspan="2" valign="bottom"><h2>Expedientes salidos del organismo (cant: <?=$cant3; ?>)</h2></td>
  </tr>
  <tr>
    <td height="6" colspan="2" valign="bottom">&nbsp;</td>
  </tr>
